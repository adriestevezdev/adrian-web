...
import { AnimatedBeamMultipleOutputDemo } from "@/components/animatedBeamMultOutDemo";
  ...
  },
  {
    ...
    background: (
      <Calendar
        ...
        className="absolute right-0 top-6 origin-top scale-90 rounded-md border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:scale-95"
      />
    ),
  },
];
