    ...
    <div className="relative mx-auto max-w-5xl overflow-hidden rounded-xl border border-gray-800 bg-gray-900/50 shadow-2xl backdrop-blur">
      ...
      <div className="p-6">
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 rounded-md border border-gray-800 px-3 py-1.5">
              ...
              <span className="text-sm text-gray-400">Jan 20, 2023 - Feb 09, 2023</span>
            </div>
        ...
        <div className="grid gap-4 lg:grid-cols-4">
          <StatCard title="Total Revenue" value="$45,231.89" change="+20.1%" trend="up" subtitle="from last month" />
          <StatCard title="Subscriptions" value="+2350" change="+180.1%" trend="up" subtitle="from last month" />
          <StatCard title="Sales" value="+12,234" change="+19.4%" trend="up" subtitle="from last month" />
          <StatCard title="Active Now" value="+573" change="+201" trend="up" subtitle="since last hour" />
        </div>
      </div>
    </div>
  )
